...
"""
Test utils from: https://github.com/peterbe/
tornado-utils/blob/master/tornado_utils/http_test_client.py
"""
...
class HTTPClientMixin(object):
    ...
    def _fetch(
            self, url, method, data=None, headers=None, follow_redirects=True):
