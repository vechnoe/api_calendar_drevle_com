...
$(function () {
  ...
  var ajax = function(url, callback) {
    if(
      url.indexOf('api.calendar.drevle.com') != 7 &&
      url.indexOf('api.calendar.drevle.com') != 8 &&
      url.indexOf('api.calendar.drevle.com') != 11 &&
      url.indexOf('api.calendar.drevle.com') != 12 &&
